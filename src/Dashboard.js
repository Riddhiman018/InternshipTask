      ...
      <div className="h-screen flex">
        ...
        >
          ...
          >
            ...
            <div className="mt-1 mb-4 flex items-center justify-start">
              <span className="text-sm">Show Displays</span>
              <button
                type="button"
            ...
            <div className="flex flex-col mt-2">
              {a.map((item) => (
                <div className="flex flex-row mt-2 relative">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6 absolute right-4 text-gray-500 top-3"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"

        ...
        <div class="w-full max-w-lg  relative mx-auto my-auto shadow-lg bg-white ">
          <div class="">
            <div class="flex flex-row justify-between p-6 bg-black text-white border-b border-gray-200 ">
              <p class="font-semibold text-white">Add Content</p>
              <svg
                class="w-6 h-6"
                fill="none"
                stroke="currentColor"
            ...
            <div className="flex flex-row">
              <p class="w-1/2 p-4 font-normal border rounded border-gray-50 text-gray-300">
                Upload Files
              </p>
              <p class="p-4 w-1/2 font-normal border rounded border-gray-50 text-gray-300">
                Upload Web content
              </p>
            </div>
